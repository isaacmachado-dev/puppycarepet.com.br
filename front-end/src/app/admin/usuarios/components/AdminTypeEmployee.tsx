            ...
            <DropdownMenu open={dropdownActive} onOpenChange={setDropdownActive}>
                <DropdownMenuTrigger asChild>
                    <Button
                        variant="outline"
                        className={cn(
                            "p-2 pl-10 bg-white dark:bg-[#171717] group-hover:placeholder-black rounded-sm p-2 w-70 h-10 justify-start !text-left cursor-pointer group !ring-0 shadow-none border-2 border-none outline-2 hover:outline-2 w-[250px]",
