...
export default function AdminPage() {
  ...
  return (
    <div>
      <div className="relative flex min-h-screen bg-[#E3E3E3] text-black font-bold">
        <aside
          className={`relative z-10 bg-[#1A112E] shadow-lg py-4 px-4 transition-all duration-300 ${
          ...
          <div className="sticky top-5 flex flex-col gap-2">
            <header className="relative flex items-center gap-2 min-h-[50px]">
              ...
              */}
              ...
              <span
                className={`text-white text-sm transition-all duration-300 overflow-hidden ${
                  isOpen
            ...
            <div className="text-black hover:text-white transition-all duration-300">
              <AdminMenuItem
                icon={<X color="currentColor" />}
                className={`${
                  !isOpen ? "flex justify-center align-center" : "justify-start"
                }`}
                label="Sair"
