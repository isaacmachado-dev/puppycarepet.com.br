...
export const CartAlergicSick: React.FC<CartAlergicSickProps> = ({ label }) => {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col col-span-1 h-full min-h-[120px]">
        ...
        <div className="flex flex-1 flex-row gap-4 items-end mt-auto">
          ...
          <div className="flex flex-col items-center justify-end h-full">
            ...
            <select
              className="h-[48px] min-w-[100px] text-base px-8 py-2.5 font-bold border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#1A112E] transition bg-white disabled:bg-gray-100 disabled:text-gray-400"
