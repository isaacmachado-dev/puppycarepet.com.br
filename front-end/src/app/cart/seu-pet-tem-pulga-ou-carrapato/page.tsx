                  ...
                  <div className="flex flex-col col-span-1">
                    <div className="flex gap-4 h-full items-end">
                      <span className="w-full">
                        <Button
                          variant={
                            activeOption === "Pulga" ? "default" : "outline"
                          }
                          onClick={() => setActiveOption("Pulga")}
                          aria-pressed={activeOption === "Pulga"}
                      ...
                      <span className="w-full">
                        <Button
                          variant={
                            activeOption === "Carrapato" ? "default" : "outline"
                          }
                          onClick={() => setActiveOption("Carrapato")}
                          aria-pressed={activeOption === "Carrapato"}
                          className={`h-[48px] w-full min-w-[100px] text-base px-8 py-4 font-bold flex items-center justify-center transition
                            ${
                              activeOption === "Carrapato"
                                ? "bg-[#1A112E] text-white hover:bg-[#0A002E]"
                                : "bg-white text-[#1A112E] border-2 border-[#1A112E] hover:bg-[#f3f3f3]"
                            }
                          `}
                      ...
                      <span className="w-full">
                        <Button
                          variant={
                            activeOption === "Não tem" ? "default" : "outline"
                          }
                          onClick={() => setActiveOption("Não tem")}
                          aria-pressed={activeOption === "Não tem"}
                          className={`h-[48px] w-full min-w-[100px] text-base px-8 py-4 font-bold flex items-center justify-center transition
                            ${
                              activeOption === "Não tem"
                                ? "bg-[#1A112E] text-white hover:bg-[#0A002E]"
                                : "bg-white text-[#1A112E] border-2 border-[#1A112E] hover:bg-[#f3f3f3]"
                            }
                          `}
                ...
                <div className="w-full flex justify-between items-center mt-4">
                  <div className="flex justify-between items-center mt-4">
                    <span>
                      <p className="text-sm text-black">
                        ...
                        Sujeito a taxa adicional de R$10,00 por serviço.
                      </p>
                    </span>
                  </div>
                  <div className="flex items-center mt-4">
                    <span className="flex-1 flex justify-end">
                      ...
                      >
                        <a href="/cart/qual-e-o-temperamento-do-seu-pet">
                          Continuar
                        </a>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
